...
lint-py:  ## run python linter with ruff
	python -m ruff check perspective_parquet
	python -m ruff format --check perspective_parquet
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix perspective_parquet
	python -m ruff format perspective_parquet
...
test-py:  ## run python tests
	python -m pytest -v perspective_parquet/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v perspective_parquet/tests --cov=perspective_parquet --cov-report term-missing --cov-report xml
