...
testpy: ## Clean and Make unit tests
	python -m pytest -v perspective_parquet/tests --junitxml=junit.xml --cov=perspective_parquet --cov-report xml --cov-branch --cov-fail-under=20 --cov-report term-missing
...
clean: ## clean the repository
	...
	rm -rf perspective_parquet/labextension perspective_parquet/nbextension/static/index*
	cd js && yarn clean
	git clean -fd
